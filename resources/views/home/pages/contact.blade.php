        ...
        <div class="container">
            <ul class="list-unstyled contact-info__list">
                ...
                <li class="contact-info__single">
                    ...
                    <p>
                        <a href="mailto:elitewashlaundryng@gmail.com"
                            class="contact-info__mail-1">elitewashlaundryng@gmail.com</a>
                        {{-- <a href="mailto:elitewashlaundryng@gmail.com"
                            class="contact-info__mail-2">elitewashlaundryng@gmail.com</a> --}}
                    </p>
                </li>
                <li class="contact-info__single">
                    <div class="contact-info__icon">
